...
use App\Nova\PageManager;
use App\Nova\RegionManager;
...
return [
    ...
    */
    ...
    'pages_table' => 'pages_managers',
    'regions_table' => 'regions_managers',
    ...
    */
    ...
    'region_resource' => RegionManager::class,
    'page_model' => \Outl1ne\PageManager\Models\Page::class,
    'page_resource' => PageManager::class,
